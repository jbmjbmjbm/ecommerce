  	...
  	<div class="col-md-12">
        ...
        <form role="form" action="/admin/users/<?php echo htmlspecialchars( $user["iduser"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" method="post">
          <div class="box-body">
            ...
            <!div class="form-group">
              <!label for="despassword"><!/label>
              <!input type="text" class="form-control" id="despassword" name="despassword" placeholder="Digite a senha" value="<?php echo htmlspecialchars( $user["despassword"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
            <!/div>
            <div class="checkbox">
              <label>
