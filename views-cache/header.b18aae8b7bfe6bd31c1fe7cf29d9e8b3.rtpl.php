...
<head>
  ...
  <title>João Monteiro | Inicio</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.html" class="logo">
      ...
      <span class="logo-lg"><b>Monteiro </b>Sistemas</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">João Monteiro</span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  João Monteiro - Analista de Sistemas
                  <small>Membro desde Maio. 2019</small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
